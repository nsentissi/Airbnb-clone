...
const PhotosUploader = ({ addedPhotos, onChange }) => {
  ...
  const addPhotoByLink = async (e) => {
    e.preventDefault();
    const { data: filename } = await axios.post("/api/rentals/upload-by-link", {
      link: photoLink,
    });
    onChange((prev) => {
          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-2 right-1 text-white bg-black bg-opacity-50 cursor-pointer rounded-xl p-2 "
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black bg-opacity-50 cursor-pointer rounded-xl p-2 "
              >
                {link !== addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
